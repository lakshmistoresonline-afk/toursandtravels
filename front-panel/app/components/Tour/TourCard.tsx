			...
			>
				...
				<div className="relative aspect-[4/3] overflow-hidden bg-muted">
					...
					<div className="absolute top-4 left-4 z-20">
						<Badge
							className={cn(
								"px-3 py-1 text-[8px] font-bold uppercase tracking-widest border backdrop-blur-md rounded-full",
				...
				<div className="p-7 flex flex-col flex-1 gap-6">
					<div className="flex-1 space-y-3">
						<h3 className="font-serif text-xl leading-tight text-foreground group-hover:text-primary transition-colors line-clamp-2">
							{tour.name}
						</h3>

						<div className="flex flex-wrap items-center gap-4 text-foreground/50 text-[10px] font-bold uppercase tracking-widest">
					...
					<div className="pt-5 border-t border-primary/10 flex items-center justify-between">
						<div className="space-y-0.5">
							<p className="text-[9px] text-foreground/40 uppercase tracking-widest font-bold">
								Exchange
							</p>
						...
						<div className="text-[9px] font-bold uppercase tracking-widest text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-all bg-primary/5 px-4 py-2 rounded-full border border-primary/20">
							Details
						</div>
					</div>
				</div>
