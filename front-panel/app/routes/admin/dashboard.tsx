		...
		<div className="space-y-12 animate-in fade-in duration-700">
			...
			<div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-white/5 pb-10">
				<div className="space-y-2">
					<h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#d4af37]">Operational Sanctuary</h4>
					<h1 className="text-5xl font-serif text-[#fdfcf0] tracking-tight">Admin Overview</h1>
					<p className="text-[#fdfcf0]/40 text-xs font-sans font-bold uppercase tracking-widest leading-relaxed">Overseeing sacred paths and spiritual journeys.</p>
				</div>
			</div>
