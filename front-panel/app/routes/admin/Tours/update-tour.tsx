					...
					<div className="bg-white/5 border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl">
						<div className="bg-[#d4af37]/5 p-8 border-b border-white/5 flex items-center gap-4">
							...
							<div>
								...
								<p className="text-[#fdfcf0]/40 text-[10px] uppercase tracking-widest">Core journey identifiers.</p>
							</div>
						</div>
							...
							<div className="md:col-span-2">
								<FormField control={control} name="overview" render={({ field }) => (
									<FormItem>
										...
										<FormControl><Textarea placeholder="Describe the journey..." className="min-h-[160px] rounded-2xl bg-white/5 border-white/10 p-6 text-[#fdfcf0]/70 text-sm leading-relaxed outline-none focus:ring-1 focus:ring-[#d4af37]/20 resize-none" {...field} /></FormControl>
										<FormMessage className="text-red-400 text-[8px] font-bold uppercase tracking-widest ml-2" />
									</FormItem>
								)} />
							</div>
					...
					<div className="bg-white/5 border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl">
						<div className="bg-[#d4af37]/5 p-8 border-b border-white/5 flex items-center gap-4">
							...
							<div>
								...
								<p className="text-[#fdfcf0]/40 text-[10px] uppercase tracking-widest">Financial and capacity settings.</p>
							</div>
						</div>
						<div className="p-8 grid md:grid-cols-2 gap-8">
						...
						<div className="bg-[#d4af37]/5 p-8 border-b border-white/5 flex items-center justify-between">
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-[#fdfcf0]/40 text-[10px] uppercase tracking-widest">The spiritual roadmap.</p>
								</div>
							</div>
						...
						<div className="p-8">
							<FormField control={control} name="cover_image" render={({ field }) => (
								<FormItem>
									...
									<FormControl><Input placeholder="https://..." className="h-12 rounded-xl bg-white/5 border-white/10 text-[#fdfcf0] text-sm" {...field} /></FormControl>
									<FormMessage className="text-red-400 text-[8px] font-bold uppercase tracking-widest ml-2" />
								</FormItem>
							)} />
						</div>
