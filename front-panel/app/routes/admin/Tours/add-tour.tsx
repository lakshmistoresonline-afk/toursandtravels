					...
					<div className="surface-card-strong rounded-[2rem] overflow-hidden shadow-2xl">
						<div className="bg-[#d4af37]/10 p-8 border-b border-white/5 flex items-center gap-4">
							...
							<div>
								...
								<p className="text-[#fdfcf0]/60 text-[10px] uppercase tracking-widest">Journey identifiers and descriptions.</p>
							</div>
						</div>
					...
					<div className="surface-card-strong rounded-[2rem] overflow-hidden shadow-2xl">
						<div className="bg-[#d4af37]/10 p-8 border-b border-white/5 flex items-center gap-4">
							...
							<div>
								...
								<p className="text-[#fdfcf0]/60 text-[10px] uppercase tracking-widest">Define exchange and pilgrims limit.</p>
							</div>
						</div>
						<div className="p-8 grid md:grid-cols-2 gap-8 bg-black/20">
						...
						<div className="bg-[#d4af37]/10 p-8 border-b border-white/5 flex items-center justify-between">
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-[#fdfcf0]/60 text-[10px] uppercase tracking-widest">Day-by-day spiritual schedule.</p>
								</div>
							</div>
						...
						<div className="p-8 bg-black/20">
							<FormField control={control} name="cover_image" render={({ field }) => (
								<FormItem>
									...
									<FormControl><Input placeholder="https://images.unsplash.com/..." className="h-12 rounded-xl bg-black/40 border-white/10 text-[#fdfcf0] text-sm focus-visible:ring-[#d4af37]/20" {...field} /></FormControl>
									<FormMessage className="text-red-400 text-[8px] font-bold uppercase tracking-widest ml-2" />
								</FormItem>
							)} />
						</div>
