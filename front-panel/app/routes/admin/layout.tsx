			...
			<nav className="bg-[#0a0e1a]/90 backdrop-blur-2xl border-b border-[#d4af37]/20 px-8 py-4 flex justify-between items-center sticky top-0 z-50 shadow-2xl">
				<div className="flex items-center gap-12">
					<Link to="/admin" className="flex items-center gap-4 group">
						<div className="h-10 w-10 rounded-full glass-card border border-[#d4af37]/30 flex items-center justify-center text-[#d4af37] shadow-[0_0_10px_rgba(212,175,55,0.3)] transition-transform duration-500 group-hover:scale-110">
