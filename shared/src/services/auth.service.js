import { signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, sendPasswordResetEmail, onAuthStateChanged, getAuth } from "firebase/auth";
...
export class AuthService extends Service {
    ...
    async getFullCurrentUser() {
        ...
        if (!firebaseUser)
            return { user: null, error: new ApiError("Not authenticated", 401) };
        try {
