	...
	async getFullCurrentUser(): Promise<GetFullCurrentUser> {
		...
		try {
			...
			let frontPanelUser: FullCurrentUser = {
				...
				last_name: userDetails.last_name ?? null,
				phone_number: userDetails.phone_number ?? null,
				whatsapp_number: userDetails.whatsapp_number ?? null,
				gender: userDetails.gender ?? null,
				date_of_birth: userDetails.date_of_birth ?? null,
				address_house: userDetails.address_house ?? null,
				address_street: userDetails.address_street ?? null,
				address_locality: userDetails.address_locality ?? null,
				address_post_office: userDetails.address_post_office ?? null,
				address_district: userDetails.address_district ?? null,
				address_state: userDetails.address_state ?? null,
				address_pin_code: userDetails.address_pin_code ?? null,
				identity_type: userDetails.identity_type ?? null,
				identity_number: userDetails.identity_number ?? null,
				emergency_contact_name: userDetails.emergency_contact_name ?? null,
				emergency_contact_number: userDetails.emergency_contact_number ?? null,
				emergency_contact_relationship: userDetails.emergency_contact_relationship ?? null,
			...
			if (userDetails != null && !frontPanelUser.avatar_url) {
	...
	async updateUserProfile(data: ProfileUpdateForm & { user_id: string }) {
		const { data: profileData, error: profileError } = await this.supabase
			...
			.update({
				...
				address_post_office: data.address_post_office,
