...
export const AddTourActionSchema = z.object({
	...
	max_participants: z.number().int().nonnegative().optional().default(0),
	price: z.number().nonnegative().optional().default(0),
	status: z.enum(["DRAFT", "PUBLISHED", "REGISTRATION_OPEN", "REGISTRATION_CLOSED", "UPCOMING", "ONGOING", "COMPLETED", "CANCELLED"]).default("DRAFT"),

	city_id: z.string().min(1),
	tour_category_id: z.string().min(1),
	...
	itinerary: z.array(z.object({
		...
		overnight_location: z.string().optional(),
	...
	// Keep tour_options for backward compatibility if needed, but make it optional
	tour_options: TourOptionsSchema.optional(),
});
...
const PartialUpdateTourSchema = z.object({
	...
	price: z.number().optional(),
	status: z.enum(["DRAFT", "PUBLISHED", "REGISTRATION_OPEN", "REGISTRATION_CLOSED", "UPCOMING", "ONGOING", "COMPLETED", "CANCELLED"]).optional(),
	departure_location: z.string().nullable().optional(),
	return_location: z.string().nullable().optional(),
