	...
	public: {
		Tables: {
			...
			tour_registrations: {
				...
				Relationships: [
					{
						foreignKeyName: "tour_registrations_customer_id_fkey";
						columns: ["customer_id"];
						isOneToOne: false;
						referencedRelation: "app_users";
						referencedColumns: ["user_id"];
		...
		Enums: {
			...
			tour_status: "DRAFT" | "PUBLISHED" | "REGISTRATION_OPEN" | "REGISTRATION_CLOSED" | "UPCOMING" | "ONGOING" | "COMPLETED" | "CANCELLED";
